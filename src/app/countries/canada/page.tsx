...
const ALL_CITIES = [
  { name: "Toronto", src: "/images/countries/canada/Toronto.avif", objectPosition: "center", filter: "none" },
  { name: "Vancouver", src: "/images/countries/canada/Vancouver.jpg", objectPosition: "center", filter: "none" },
  { name: "Calgary", src: "/images/countries/canada/Calgary.jpg", objectPosition: "top center", filter: "saturate(0.7) brightness(0.82) hue-rotate(-10deg)" },
  { name: "Edmonton", src: "/images/countries/canada/Edmonton.jpg", objectPosition: "center", filter: "brightness(0.75) saturate(0.85)" },
  { name: "Montreal", src: "/images/countries/canada/Montreal.jpg", objectPosition: "bottom center", filter: "sepia(0.15) brightness(0.88)" },
];
