    ...
    <main style={{ backgroundColor: "#FFFFFF", color: "#18191D", minHeight: "100vh" }}>
      ...
      <section className="inner-hero-section" style={{
        ...
        <div style={{ maxWidth: "1200px", zIndex: 10, position: "relative" }}>
          ...
          >
            <span>Branding</span>
            <span style={{ paddingLeft: "20%" }}>& Strategy</span>
          </motion.h1>
          ...
          >
            We build brands that feel credible, familiar and trusted — in every culture, every market, every room your audience walks into.
          </motion.p>
        ...
        >
          <Image
            src="/images/services/branding-strategy/banner.png"
            alt="Branding Strategy - Chess King"
            fill
      ...
      >
        ...
        <div style={{ position: "absolute", top: "4rem", right: "10%", zIndex: 10 }}>
          <div
            style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "#333", fontSize: "1.1rem", textDecoration: "none", fontWeight: 500, background: "none", border: "none" }}
          >
        ...
        >
          ...
          >
            ...
            <div style={{ position: "relative", width: "100%", height: "100%", pointerEvents: "none", overflow: "hidden" }}>
              <Image
                src="/images/services/branding-strategy/chess.png"
                alt="Branding Strategy - Chess King"
                fill
                style={{
                  objectFit: "cover",
          ...
          >
            ...
            <div style={{ backgroundColor: "#18191D", padding: "1rem", color: "#FFF", borderLeft: "1px solid rgba(255,255,255,0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <motion.div 
                ...
                style={{ backgroundColor: "#FFF", color: "#18191D", borderRadius: "50%", width: "24px", height: "24px", display: "flex", alignItems: "center", justifyContent: "center" }}
              >
