...
const TextCloud = ({ isMagnified = false }: { isMagnified?: boolean }) => (
  <div style={{
    ...
    <span style={{ color: "#18191D", fontWeight: 800 }}>Reaching everyone</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>means</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>reaching no one.</span>
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>We build campaigns targeting</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>specific communities</span>
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>with the</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>cultural depth</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>and</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>precision</span>
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>that</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>real performance</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>demands.</span>
  </div>
);
    ...
    <main style={{ backgroundColor: "#FFFFFF", color: "#18191D", minHeight: "100vh" }}>
      ...
      <section className="inner-hero-section" style={{
        ...
        <div style={{ maxWidth: "1200px", zIndex: 10, position: "relative" }}>
          ...
          >
            <span>Digital</span>
            <span style={{ paddingLeft: "20%" }}>Advertising</span>
          </motion.h1>
          ...
          >
            We run precision multicultural ad campaigns across platforms, formats and markets — reaching the communities that matter and delivering results that move the business forward.
          </motion.p>
        ...
        >
          <Image
            src="/images/services/digital-advertising/banner.png"
            alt="Digital Advertising - Image"
            fill
