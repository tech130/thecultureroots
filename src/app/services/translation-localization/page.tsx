...
const TextCloud = ({ isMagnified = false }: { isMagnified?: boolean }) => (
  <div style={{
    ...
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>Speaking a</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>language</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>is not the same as understanding a</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>culture.</span>
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>We make sure your</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>message</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>does not just</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>cross borders</span>
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>— it</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>belongs</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>on the other side.</span>
  </div>
);
      ...
      <section className="inner-hero-section" style={{
        ...
        <div style={{ maxWidth: "1200px", zIndex: 10, position: "relative" }}>
          ...
          >
            ...
            <span style={{ paddingLeft: "20%" }}>& Localization</span>
          </motion.h1>
          ...
          >
            We make your brand voice feel native across languages, dialects and cultural contexts — so your message lands with the same weight in every market you enter.
          </motion.p>
        ...
        >
          <Image
            src="/images/services/translation-localization/banner.png"
            alt="Translation & Localization - Image"
            fill
