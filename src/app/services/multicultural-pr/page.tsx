...
const TextCloud = ({ isMagnified = false }: { isMagnified?: boolean }) => (
  <div style={{
    ...
    <span style={{ color: "#18191D", fontWeight: 800 }}>Your story matters.</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>But only if the</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>right people</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>are telling it —</span>
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>in the</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>right language,</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>through the</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>right voices,</span>
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>to the</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>right communities.</span>{" "}
    <span style={{ color: isMagnified ? "#000" : "rgba(24,25,29,0.3)", fontWeight: isMagnified ? 400 : 300 }}>We</span>{" "}
    <span style={{ color: "#18191D", fontWeight: 800 }}>make that happen.</span>
  </div>
);

export default function MulticulturalPRPage() {
      ...
      <section className="inner-hero-section" style={{
        ...
        <div style={{ maxWidth: "1200px", zIndex: 10, position: "relative" }}>
          ...
          >
            ...
            <span style={{ paddingLeft: "20%" }}>PR</span>
          </motion.h1>
          ...
          >
            We build brand narratives that earn credibility across diverse media ecosystems — from ethnic press to mainstream outlets — where trust takes time and authenticity is everything.
          </motion.p>
        ...
        >
          <Image
            src="/images/services/multicultural-pr/banner.png"
            alt="Multicultural PR - Image"
            fill
