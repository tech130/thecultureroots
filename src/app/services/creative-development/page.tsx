    ...
    <main style={{ backgroundColor: "#FFFFFF", color: "#18191D", minHeight: "100vh" }}>
      ...
      <section className="inner-hero-section" style={{
        ...
        <div style={{ maxWidth: "1200px", zIndex: 10, position: "relative" }}>
          ...
          >
            <span>Creative</span>
            <span style={{ paddingLeft: "20%" }}>Development</span>
          </motion.h1>
          ...
          >
            We develop campaigns, content and visuals built with cultural intelligence at the core — so every piece of creative earns attention from the audience you are trying to reach.
          </motion.p>
        ...
        >
          <Image
            src="/images/services/creative-development/anner.png"
            alt="Creative Development - Image"
            fill
